...
Snapshot copy (2026-09-11) of Diffusion-Planner/agg_speedscope.py -- the skill
bundle is self-contained by convention; sync manually if the source evolves.
Usage guide: ../references/profiling-pyspy.md
"""
import json
import sys

...
- 覆盖小结（终态）：**task0-3 四任务 × tl144/145/146 三桶 = 160/160 帧全覆盖回放，零集成性离群**——

  | task | L=144 | L=145 | L=146 | P50 带 |
  |---|---|---|---|---|
  | task0 | ×32 194.1% | ×8 179.2% | — | 179-194% |
  | task1 | — | ×28 222.5% | ×12 197.7% | 198-223% |
  | task2 | ×1 188.7% | ×17 187.3% | ×22 181.8% | 182-189% |
  | task3 | ×4 207.3% | ×14 206.2% | ×22 202.9% | 203-207% |

  全部 fp16 残差 + 混沌放大同类；**闭环 policy 的桶集 = 遇到新长度按需补烤**（bake_one.sh ~4 分钟/桶对，磁盘 1.1T 余）
